      ...
      <div className="container mx-auto px-4 md:px-6 relative z-20">
        <div className="flex flex-col items-center text-center max-w-4xl mx-auto">
          <div className="space-y-6">
            <div className="inline-block px-3 py-1 rounded-full bg-dark-400/80 backdrop-blur-sm border border-cyan/20 text-sm animate-in stagger-1">
              <span className="text-gray-300">Open Source Models • No API Keys Required</span>
            </div>
            
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold tracking-tight animate-in stagger-2">
              <span className="block">Generate AI Content with</span>
              <span className="glow-text text-glow mt-2 block">Unmatched Freedom</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center pt-4 animate-in stagger-4">
              ...
              <Button variant="outline" className="border-cyan/30 hover:border-cyan/60 text-gray-100 px-8 py-6 text-lg hover-glow">
                Explore Models
              </Button>
            </div>
          </div>
